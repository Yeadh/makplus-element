...
// Banner
class makplus_Widget_Banner8 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner video 1', 'makplus' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_section',
            [
                'label' => esc_html__( 'Banner video 1', 'makplus' ),
                            ...
                            <div class="slider-content">
                                ...
                                <div class="search-fields">
                                    <form action="<?php echo esc_url(home_url( '/' )); ?>">
                                        <input type="text" name="s"  placeholder="<?php echo esc_attr_x( 'Search here...', 'placeholder', 'makplus' ); ?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new makplus_Widget_Banner8 );