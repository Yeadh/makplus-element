...
class makplus_Widget_Banner3 extends Widget_Base {
   ...
   protected function render( $instance = [] ) {
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                        <div class="s-slider-img position-relative wow fadeInRight" data-wow-delay="0.6s">
                            <img src="<?php echo esc_url( $settings['Banner 3_image']['url'] ) ?>" alt="img">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <section class="slider-area slider-bg fix digital-slider-bg" data-background="<?php echo esc_url( $settings['Banner 3_image']['url'] ) ?>">
          <div class="container">
                      ...
                      <div class="row justify-content-center text-center">
                          <div class="col-lg-10">
                              ...
                              <div class="t-slider-img wow fadeInUp" data-wow-delay="0.8s">
                                  <img src="<?php echo esc_url( $settings['Banner 3_image']['url'] ) ?>" class="alltuchtopdown" alt="img">
                              </div>
                          </div>
                      </div>
                  </div>
