...
// Product
class Makplus_Widget_Videos_Nofilter extends Widget_Base {
 
   public function get_name() {
      return 'videossnofilter';
   }
 
   public function get_title() {
      return esc_html__( 'Videos without Filter', 'makplus' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'product_section',
         [
            'label' => esc_html__( 'Videos without Filter', 'makplus' ),
      ...
      $settings = $this->get_settings_for_display(); ?>
              ...
              <div class="image_gallery">
                ...
                global $product;?>
                     ...
                     <div class="image_gallery_item latest-games-thumb makplus_relatedvideo">
                        <a href="<?php the_permalink(); ?>">
                           <?php the_post_thumbnail('makplus-360-500'); ?>
                        </a>
						<div class="new_release_hover">
						   <div class="new_release_hover_preview video-thumb">
								<a href="<?php echo esc_url( get_post_meta( get_the_ID(), 'makplus_video', 1 )); ?>" class="pulse popup-video"><i class="fas fa-play"></i></a>
						   </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Makplus_Widget_Videos_Nofilter );