...
// Banner
class uhu_Widget_Banner4 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner Flat', 'makplus' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_section',
            [
                'label' => esc_html__( 'Banner 4', 'makplus' ),
    ...
    protected function render( $instance = [] ) {
        ...
        <section class="slider-area slider-bg">
            ...
            <div class="container">
                <div class="slider-wrap home_four">
...
Plugin::instance()->widgets_manager->register_widget_type( new uhu_Widget_Banner4 );